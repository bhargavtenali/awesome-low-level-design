...
public class LibraryManagementDemo {
    ...
    public static void main(String[] args) {
        ...
        List<BookCopy> hobbitCopies = library.addBook(
                "B001",
                "The Hobbit",
                "J.R.R. Tolkien",
                "978-0547928227",
        ...
        List<BookCopy> duneCopies = library.addBook(
                "B002",
                "Dune",
                "Frank Herbert",
                "978-0441172719",
        ...
        library.searchByTitle("Dune")
                .forEach(book -> System.out.println("Found: " + book.getTitle()));
        ...
        System.out.println("Trying to checkout an already checked-out copy:");
        ...
        library.returnBook(alice.getId(), hobbitCopies.get(0).getId());

        library.printCatalog();

        System.out.println("Alice active loans: " + library.getLoans(alice.getId()).size());
        System.out.println("Bob active loans: " + library.getLoans(bob.getId()).size());
    }
}